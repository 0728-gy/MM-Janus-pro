...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_results_adaptive_final_logits_top_1/SLURM-%j.out
...
RES_DIR="/scratch/gongzx/MM2026/geneval_results_adaptive_final_logits_top_1/janus_pro_7b_adaptive_kj${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
