...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_top_1/SLURM-%j.out

# ================= 1. 统一变量配置 =================

#1.2 1.7 1.5 2.0 2.5 2.2
...
RES_DIR="/scratch/gongzx/MM2026/geneval_top_1/janus_pro_7b_adaptive_j${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
...
torchrun --nproc_per_node=4 /home/gongzx/share/MM2026/Janus/MM-Janus-pro/top-1.py \
