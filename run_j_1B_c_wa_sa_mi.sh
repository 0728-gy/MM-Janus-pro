...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_1b_c_wa_sa_mi/SLURM-%j.out
...
RES_DIR="/scratch/gongzx/MM2026/geneval_1b_c_wa_sa_mi/kj${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
