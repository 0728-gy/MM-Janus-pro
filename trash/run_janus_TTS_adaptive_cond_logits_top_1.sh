...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_results_adaptive_top_1/SLURM-%j.out
...
RES_DIR="/scratch/gongzx/MM2026/geneval_results_adaptive/janus_pro_7b_adaptive_top_1j${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
...
torchrun --nproc_per_node=4 /home/gongzx/share/MM2026/Janus/MM-Janus-pro/for_geneval_adaptive_condi_logits.py \
