...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_7b_c_wa_sa_mi_minwindow_1/SLURM-%j.out
...
RES_DIR="/scratch/gongzx/MM2026/geneval_7b_c_wa_sa_mi_minwindow_1/kj${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
...
torchrun --nproc_per_node=4 /home/gongzx/share/MM2026/Janus/MM-Janus-pro/for_geneval_a_c_nbatr.py\
