...
#SBATCH --time=3:00:00
#SBATCH --output=/scratch/gongzx/MM2026/geneval_1B/SLURM-%j.out
...
RES_DIR="/scratch/gongzx/MM2026/geneval_1B/janus_pro_1b_adaptive_kj${K_JUMP}_km${K_MEAN}_min${MIN_WINDOW}_max${MAX_WINDOW}"
...
torchrun --nproc_per_node=4 /home/gongzx/share/MM2026/Janus/MM-Janus-pro/for_geneval_adaptive_final_logits.py\
